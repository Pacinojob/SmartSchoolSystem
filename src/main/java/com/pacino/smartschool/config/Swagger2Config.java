...
public class Swagger2Config {
    ...
    public Docket webApiConfig(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.pacino.smartschool.controller"))
                //过滤掉admin路径下的所有页面
    ...
    private ApiInfo webApiInfo(){
        ...
        return new ApiInfoBuilder()
                ...
                .version("1.0")
                .contact(new Contact("pacino", "https://www.pacino.com", "2690564987@qq.com"))
                .build();
    }
